...
Object(_modules_tooltips__WEBPACK_IMPORTED_MODULE_9__["tooltips"])();
...
var tabs = function tabs() {
  ...
  var initSliders = function initSliders() {
    var tabEls = tabsList.querySelectorAll('.modal-info__item');
    tabEls.forEach(function (tab) {
      var sliderContainer = tab.querySelector('.swiper-container');

      if (sliderContainer) {
        var pagination = sliderContainer.querySelector('.swiper-pagination');
        var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderContainer, {
          navigation: false,
          spaceBetween: 1,
          observer: true,
          observeParents: true
