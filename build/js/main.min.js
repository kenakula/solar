...
/* harmony import */ var _modules_sky__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/sky */ "./js/modules/sky.js");
/* harmony import */ var _modules_animate_orbits__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/animate-orbits */ "./js/modules/animate-orbits.js");
/* harmony import */ var _modules_set_speed__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/set-speed */ "./js/modules/set-speed.js");
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/tabs */ "./js/modules/tabs.js");
/* harmony import */ var _modules_preload__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/preload */ "./js/modules/preload.js");
/* harmony import */ var _modules_tooltips__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/tooltips */ "./js/modules/tooltips.js");
/* harmony import */ var _modules_zoom__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/zoom */ "./js/modules/zoom.js");
/* harmony import */ var _modules_planets__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/planets */ "./js/modules/planets.js");
...
Object(_modules_sky__WEBPACK_IMPORTED_MODULE_4__["drawStars"])();
Object(_modules_animate_orbits__WEBPACK_IMPORTED_MODULE_5__["animateOrbits"])();
Object(_modules_set_speed__WEBPACK_IMPORTED_MODULE_6__["setSpeed"])();
Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_7__["tabs"])();
Object(_modules_preload__WEBPACK_IMPORTED_MODULE_8__["preload"])();
Object(_modules_tooltips__WEBPACK_IMPORTED_MODULE_9__["tooltips"])(); // zoom();
// planets();

/***/ }),

/***/ "./js/modules/animate-orbits.js":
/*!**************************************!*\
  !*** ./js/modules/animate-orbits.js ***!
  \**************************************/
/*! exports provided: animateOrbits */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animateOrbits", function() { return animateOrbits; });
var orbits = document.querySelectorAll('.orbit');
var asteroids = document.querySelector('.asteroid-belt');

var setRotationSpeed = function setRotationSpeed(el) {
  var delimeter = +getComputedStyle(document.documentElement).getPropertyValue('--delimeter');
  var orbitSpeed = +el.dataset.speed;
  var animationSpeed = orbitSpeed / delimeter;
  el.style.animationDuration = "".concat(animationSpeed, "s");
};

var animateOrbits = function animateOrbits() {
...
var modalInfoBtns = document.querySelectorAll('[data-modal="info"]'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
...
var initModals = function initModals() {
  ...
  if (modalInfo && modalInfoBtns.length) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalInfo, false, modalInfoBtns);
  }
};
...
var planets = function planets() {
  ...
  var onPlanetMouseOver = function onPlanetMouseOver(evt) {
...
var preload = function preload() {
  var preloadEl = document.querySelector('.js-preload');

  var hidePreload = function hidePreload() {
    setTimeout(function () {
...
/***/ "./js/modules/set-speed.js":
/*!*********************************!*\
  !*** ./js/modules/set-speed.js ***!
  \*********************************/
/*! exports provided: setSpeed */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setSpeed", function() { return setSpeed; });
/* harmony import */ var _animate_orbits__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animate-orbits */ "./js/modules/animate-orbits.js");

var SPEED_MULTIPLIER = 10;
var toolbar = document.querySelector('.js-toolbar');
var speedText = document.querySelector('.js-speed-text span');
var currentMultiplier = +speedText.textContent;

var setSpeedOutput = function setSpeedOutput(value) {
  if (currentMultiplier === 1) {
    currentMultiplier -= 1;
  }

  var output = currentMultiplier + value;
...
var adjustSpeed = function adjustSpeed(action) {
  if (action === 'up') {
  ...
  document.documentElement.style.setProperty('--delimeter', "".concat(currentMultiplier));
  Object(_animate_orbits__WEBPACK_IMPORTED_MODULE_0__["animateOrbits"])();
};

var toolbarInterationHandler = function toolbarInterationHandler(evt) {
  var target = evt.target.closest('.main-nav__button');
...
/*!***************************!*\
  !*** ./js/modules/sky.js ***!
  \***************************/
/*! exports provided: drawStars */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "drawStars", function() { return drawStars; });
var drawStars = function drawStars() {
  var canvas = document.querySelector('.js-sky');

  if (!canvas) {
    return;
  }

  var starsCount = canvas.dataset.stars;
  var colors = canvas.dataset.colors;
  var colorRange = JSON.parse(colors);
  var ctx = canvas.getContext('2d');

  var getStarsCount = function getStarsCount(initial) {
    if (window.innerWidth < 678) {
      var result = initial / 2;
      return result;
    }
  ...
  var render = function render(canvasEl, stars, colorsArr) {
    canvasEl.width = window.innerWidth;
    canvasEl.height = window.innerHeight;

    for (var i = 0; i < +stars; i++) {
      var x = Math.random() * canvasEl.offsetWidth;
      var y = Math.random() * canvasEl.offsetHeight;
      var radius = Math.random() * 1.2;
      var hue = colorsArr[getRandom(0, colorsArr.length - 1)];
      var saturation = getRandom(50, 100);
      ctx.beginPath();
      ctx.arc(x, y, radius, 0, 360);
      ctx.fillStyle = "hsl(".concat(hue, ", ").concat(saturation, "%, 88%)");
      ctx.fill();
    }
  };
...
var tabs = function tabs() {
  var tabsBtns = document.querySelectorAll('.js-info-tabs-btn');
  var tabsList = document.querySelector('.js-info-tabs');
  ...
  var initSlider = function initSlider(container) {
    ...
    var paginationContainer = container.querySelector('.swiper-pagination');

    if (!container.swiper && container) {
      var inst = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](container, {
        spaceBetween: 1,
        navigation: {
          prevEl: prevBtn,
          nextEl: nextBtn
  ...
  var showTab = function showTab(evt) {
    var target = evt.target.closest('.js-info-tabs-btn');

    if (target) {
      var contentId = target.dataset.content;
      var activeTab = tabsList.querySelector('.modal-info__item.active');
      var contentTab = tabsList.querySelector("[data-content=\"".concat(contentId, "\"]"));
      activeTab.classList.remove('active');
      contentTab.classList.add('active');
      var sliderContainer = contentTab.querySelector('.swiper-container');
...
var tooltips = function tooltips() {
  var buttons = document.querySelectorAll('.js-tooltip-btn');
  ...
  var Tooltip = /*#__PURE__*/function () {
    function Tooltip(btn) {
      ...
      this.tooltip = document.querySelector("#".concat(this.tooltipId));
      document.addEventListener('click', function (evt) {
        _this.toggleTooltip(evt);
      });
    }

    _createClass(Tooltip, [{
      key: "toggleTooltip",
      value: function toggleTooltip(evt) {
        var target = evt.target.closest('.js-tooltip-btn');
...
var zoom = function zoom() {
  var solarEl = document.querySelector('.solar__inner');
  var coords;
  var distance;
  var deltaDistance;
  ...
  var zoomSolar = function zoomSolar(newDistance) {
    var step = 10;
    var initialScale = 0.5;
    var maxScale = 4;
    var isZooming = newDistance > distance;
    deltaDistance = Math.abs(newDistance - distance);
    console.log('deltaDistance:', deltaDistance);

    if (isZooming) {// solarEl.style.transform = `translate(-50%,-44%) scale(${scale})`;
    }
  };
  ...
  var onTouchMove = function onTouchMove(evt) {
    ...
    var newDistance = updateDistance();
